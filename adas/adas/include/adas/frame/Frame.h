...
#include "adas/field/MsgId.h"
#include "adas/frame/FrameCommon.h"
...
struct FrameLayers
{
    ...
    struct SizeMembers
    {
        ...
        public:
            ...
            {
                return adas::frame::FrameLayersCommon::SizeMembersCommon::SizeFieldCommon::hasSpecials();
            }

            /// @brief Name of the field.
            static const char* name()
            {
                return adas::frame::FrameLayersCommon::SizeMembersCommon::SizeFieldCommon::name();
            }
        };
    };
...
template <
   typename TMessage,
   typename TAllMessages = adas::input::AllMessages<TMessage>,
   typename TOpt = adas::options::DefaultOptions
>
class Frame : public
