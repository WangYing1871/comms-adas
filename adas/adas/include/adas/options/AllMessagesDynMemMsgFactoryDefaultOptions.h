...
#include "adas/factory/AllMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref adas::factory::AllMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = adas::factory::AllMessagesDynMemMsgFactory<TInterface, AllMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;
