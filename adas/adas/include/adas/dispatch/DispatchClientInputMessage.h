...
#include "adas/input/ClientInputMessages.h"
...
///     like @ref adas::options::DefaultOptions.
...
///     @code
///     using MyInterface = adas::Message<...>;
///     using MyMsg1 = adas::message::Msg1<MyInterface, adas::options::DefaultOptions>;
///     using MySomeOtherMessage = SomeOtherMessage<MyInterface, adas::options::DefaultOptions>;
///     struct MyHandler {
...
/// @note Defined in adas/dispatch/DispatchClientInputMessage.h
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    ...
    case adas::MsgId_M1:
    {
        using MsgType = adas::message::Msg1<InterfaceType, TProtOptions>;
...
///     adas::options::DefaultOptions as first template parameter.
/// @param[in] id Numeric message ID.
/// @param[in] msg Message object held by reference to its interface class.
/// @param[in] handler Reference to handling object.
/// @see dispatchClientInputMessage()
...
auto dispatchClientInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchClientInputMessage<adas::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchClientInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchClientInputMessage<adas::options::DefaultOptions>(id, idx, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref adas::options::DefaultOptions.
/// @headerfile adas/dispatch/DispatchClientInputMessage.h
template <typename TProtOptions = adas::options::DefaultOptions>
struct ClientInputMsgDispatcher
{
    ...
    template <typename TMsg, typename THandler>
    static auto dispatch(adas::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(adas::dispatch::dispatchClientInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return adas::dispatch::dispatchClientInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    /// @return What the @ref dispatchClientInputMessage() function returns.
    template <typename TMsg, typename THandler>
    static auto dispatch(adas::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(adas::dispatch::dispatchClientInputMessage<TProtOptions>(id, msg, handler))
    {
        return adas::dispatch::dispatchClientInputMessage<TProtOptions>(id, msg, handler);
    }
...
///     @ref adas::options::DefaultOptions as template parameter.
/// @note Defined in adas/dispatch/DispatchClientInputMessage.h
