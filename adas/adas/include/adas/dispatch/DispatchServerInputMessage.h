...
#include "adas/input/ServerInputMessages.h"
...
/// @note Defined in adas/dispatch/DispatchServerInputMessage.h
...
auto dispatchServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchServerInputMessage<adas::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchServerInputMessage<adas::options::DefaultOptions>(id, idx, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref adas::options::DefaultOptions.
/// @headerfile adas/dispatch/DispatchServerInputMessage.h
...
struct ServerInputMsgDispatcher
{
    ...
    static auto dispatch(adas::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(adas::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return adas::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(adas::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(adas::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler))
    {
        return adas::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler);
    }
