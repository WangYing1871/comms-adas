...
#include "adas/input/AllMessages.h"
...
/// @note Defined in adas/dispatch/DispatchMessage.h
...
auto dispatchMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchMessage<adas::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchMessage<adas::options::DefaultOptions>(id, idx, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref adas::options::DefaultOptions.
/// @headerfile adas/dispatch/DispatchMessage.h
...
struct MsgDispatcher
{
    ...
    static auto dispatch(adas::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(adas::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler))
    {
        return adas::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(adas::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(adas::dispatch::dispatchMessage<TProtOptions>(id, msg, handler))
    {
        return adas::dispatch::dispatchMessage<TProtOptions>(id, msg, handler);
    }
