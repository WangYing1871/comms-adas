...
#define ADAS_ALIASES_FOR_SERVER_INPUT_MESSAGES(prefix_, suffix_, interface_, opts_) \
...
/// @param suffix_ Suffix of the alias message type.
/// @param interface_ Type of the common message interface.
#define ADAS_ALIASES_FOR_SERVER_INPUT_MESSAGES_DEFAULT_OPTIONS(prefix_, suffix_, interface_) \
    ADAS_ALIASES_FOR_SERVER_INPUT_MESSAGES(prefix_, suffix_, interface_, adas::options::DefaultOptions)
