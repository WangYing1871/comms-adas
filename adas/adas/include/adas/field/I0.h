...
/// @file
/// @brief Contains definition of <b>"I0"</b> field.
...
class I0 : public
    comms::field::IntValue<
        ...
        std::uint32_t,
        TExtraOpts...,
        comms::option::def::DefaultNumValue<0xaabbccddLL>
    >
{
    using Base =
        comms::field::IntValue<
...
public:
    ...
    {
        return adas::field::I0Common::hasSpecials();
    }

    /// @brief Name of the field.
    static const char* name()
    {
        return adas::field::I0Common::name();
    }
};
